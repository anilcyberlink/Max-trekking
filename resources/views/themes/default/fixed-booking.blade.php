                    ...
                    <div class="uk-card uk-card-default uk-card-body">
                        ...
                        @include('themes.default.common.flash-message')
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    <input class="uk-input" value="{{$booking->trip_title}}" name="" type="text" disabled>
                                </div>
                                <div class="uk-child-width-1-2@s uk-child-width-1-2m uk-text-left" uk-grid>
                                    <div>
                                        <label class="uk-form-label uk-text-theme uk-text-small" for="departure_date">Start Date</label>
                                        <div class="uk-inline" style="width: 100%;">
                                            <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: calendar"></span>
                                            <input class="uk-input" name="departure_date" type="text" placeholder="Trip Start Date *" value="{{$schedule->start_date}}" readonly>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="uk-form-label uk-text-theme uk-text-small" for="end_date">End Date</label>
                                        <div class="uk-inline" style="width: 100%;">
                                            <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: calendar"></span>
                                            <input class="uk-input" name="end_date" type="text" placeholder="Trip End Date *" value="{{$schedule->end_date}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-margin">
                                    <div>
                                        <input class="uk-input" name="num_people" type="number" placeholder="Number of people *" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
