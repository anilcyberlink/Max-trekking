...
@section('content')
    <!-- HEADER START -->
    <section class="page-banner  uk-flex uk-flex-middle uk-position-relative  uk-background-cover uk-light" data-src="{{ asset('themes-assets/images/default/default-banner.jpg') }}"  uk-img>
        <div class=" uk-padding-large uk-padding-remove-vertical">
            <div class="uk-padding">
            <h2 class="page-title uk-margin-remove uk-text-white">Results</h2>
            <ul class="uk-breadcrumb-custom uk-text-center uk-margin-top-remove">
                <li><a href="{{url('/')}}">Home</a></li>
                @if($trips->count()>0)
                  <li class="active"><span>Results found</span></li>
                @endif
            </ul>
            </div>       
        </div>
    ...
    <section class="uk-section-padding">
        <div class=" uk-container ">
            ...
            <ul class="uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-1@s uk-grid uk-margin-top" uk-height-match=".uk-text-wrp">
                @if ($trips->count() > 0)
                                ...
                                <div class=" uk-card" uk-scrollspy="cls: uk-animation-fade;  delay: 500; repeat: false">
                                    ...
                                    <div class="">
                                        <div class="uk-text-wrp">
                                            <a href="{{ url('page/' . tripurl($item->uri)) }}"><h3 class="uk-title">{{ $item->trip_title }}</h3></a>
                    ...
                    @endforeach
                @else
                  <li class="active"><span>No result found.</span></li>
                @endif
            </ul>
            <!-- list -->
            <!-- pagination -->
